...
-- acutal t1 = (Bin (Bin Tip 'a' Tip) 'b' (Bin Tip 'c' (Bin Tip 'd' Tip)))

t2 = Bin (Bin (Bin Tip 'x' Tip) 'y' Tip) 'z' t1
-- actual t2 = (Bin (Bin (Bin Tip 'x' Tip) 'y' Tip) 'z' (Bin (Bin Tip 'a' Tip) 'b' (Bin Tip 'c' (Bin Tip 'd' Tip))))

t3 :: Tree Int
t3 = Bin (Bin (Bin Tip 2 Tip) 3 (Bin Tip 1 Tip)) 7 (Bin (Bin Tip 9 Tip) 10 (Bin Tip 8 Tip))
-- actual T3 = (Bin (Bin (Bin Tip 2 Tip) 3 (Bin Tip 1 Tip)) 7 (Bin (Bin Tip 9 Tip) 10 (Bin Tip 8 Tip)))
...
-- collapse (added) xyz_code = (Fork (Leaf 'e') (Fork (Fork (Leaf 'a') (Leaf 'i')) (Fork (Leaf 'o') (Leaf 'u'))))
...
-- not really a clear test case in the occurence that either BTree == NULL of [] == Empty
decode_tests =
