...
tests =
    ...
    , test_centroid [Pt 0 0] (Pt 0 0) -- added
    , test_centroid [Pt 0 0, Pt 0 0] (Pt 0 0) -- added
    , test_centroid [] (Pt 0 0) -- added
    ...
    , test_strict (Bin (Bin Tip 'e' Tip) 'd' (Bin (Bin Tip 'a' Tip) 'b' (Bin Tip 'c' Tip))) True -- added
    , test_strict (Bin (Bin (Bin Tip 'a' Tip) 'b' (Bin Tip 'c' Tip)) 'd' (Bin (Bin Tip 'a' Tip) 'b' (Bin Tip 'c' Tip))) True -- added
    ...
    , test_near_balanced (Tip :: Tree ()) True -- added
    ]
